...
const TripHeader = ({ trip }: TripHeaderProps) => {
  return (
    <div className="flex flex-col">
      ...
      <div className="hidden lg:grid grid-cols-[2fr,1fr,1fr] gap-2 grid-rows-2 lg:order-2">{/*   grid organiza as entidades em colunas grid-cols-[2fr,1fr,1fr] a primeria coluna ocupa mais espaçoes do que as outras*/}
        <div className="relative row-span-2"> {/* a primeira foto ocupa a primeira e a segunda linha */} , {/*  a order 2 fala para div ficar em segundo nas de cima para baixo no html do site */}
          <Image
            src={trip.coverImage}
            fill
            style={{
