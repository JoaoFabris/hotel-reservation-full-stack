// instalar o ts node para executar um arquivo ts -- npm i -D ts-node
/* colocar esse script no package.json  "prisma": {
...
const inTwoMonths = today;
const inOneYear = new Date(today.getFullYear() + 20, today.getMonth(), today.getDate());
